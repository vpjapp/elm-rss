...
var $dillonkearns$elm_rss$Main$channel = {
	description: 'This podcast has zero content (almost). It will consists of the host (Ville) reading out loud any boostagram the show receives. So keep \'em coming!',
	generator: $elm$core$Maybe$Just('elm-rss/elm-podcast-rss'),
	items: _List_fromArray(
		[
			...
			enclosure: $elm$core$Maybe$Just(
				{bytes: $elm$core$Maybe$Nothing, mimeType: 'image/jpeg', url: 'https://example.com/image.jpg'}),
			pubDate: $dillonkearns$elm_rss$Rss$DateTime(
				$elm$time$Time$millisToPosix(1591330166000)),
			title: 'Generating files with elm-pages',
			url: 'blog/generate-files'
		}
		]),
	lastBuildTime: $elm$time$Time$millisToPosix(1591330166000),
...
var $dillonkearns$elm_rss$Main$cratePodcastRss = $dillonkearns$elm_rss$Rss$generate($dillonkearns$elm_rss$Main$channel);
var $elm$core$Debug$log = _Debug_log;
var $dillonkearns$elm_rss$Main$doTheMagic = A2($elm$core$Debug$log, 'Loggin', $dillonkearns$elm_rss$Main$cratePodcastRss);
...
var $dillonkearns$elm_rss$Main$nodeProgram = function (_v0) {
...
var $dillonkearns$elm_rss$Main$main = $dillonkearns$elm_rss$Main$nodeProgram($dillonkearns$elm_rss$Main$doTheMagic);
_Platform_export({'Main':{'init':$dillonkearns$elm_rss$Main$main($elm$json$Json$Decode$string)(0)}});}(this));